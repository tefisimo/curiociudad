const COLUMNAS = [
  {
    titulo: "Sitio",
    links: ["Inicio", "Ver todo", "Suscribirse", "Registrar", "Nosotros", "FAQs", "Contacto"],
  },
  {
    titulo: "Negocios",
    links: ["Registrar negocio", "Actualizar listado", "Destacar negocio", "Tarifas"],
  },
  {
    titulo: "Legal",
          ...
          {COLUMNAS.map(({ titulo, links }) => (
            <div key={titulo}>
              ...
              <ul className="flex flex-col gap-2.5">
                {links.map((link) => (
                  <li key={link}>
                    <a href="#" style={{ fontSize: "15px", color: "#47433E", textDecoration: "none" }}>
                      {link}
                    </a>
                  </li>
                ))}
